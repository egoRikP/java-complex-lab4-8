...
| **Лаб. 5** | Реалізація консольного меню з використанням **патерну Command** (кістяк). | ✅ Виконано |
| **Лаб. 6** | Додавання бізнес-логіки та сервісів (`SaladService`, `ProductService`).   | ✅ Виконано |
| **Лаб. 7** | Написання юніт-тестів (coverage ≥90%).                                    | ✅ Виконано |
...
## Лаб. 5
### "Command" Pattern Class діаграма
![lab5_class.jpg](docs/diagrams/lab5_class.jpg)
